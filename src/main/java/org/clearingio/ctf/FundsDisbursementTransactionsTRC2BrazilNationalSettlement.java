...
public class FundsDisbursementTransactionsTRC2BrazilNationalSettlement {
	...
	@Field(at = 35, length = 4, literal = "yddd", align = Align.RIGHT, padding = '0')
	private Long centralProcessingDate;

	@Field(at = 39, length = 2)
	private String istallmentPaymentCount;
